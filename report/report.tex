...
\begin{itemize}
	\item \textbf{Sanchit Jain :- }  Mitigations 4.1,4.2,4.3,4.5 ,Abstract,Appendix C,D
...
\end{itemize}
We all read different parts of the main paper and some other side notes and urls correcponding to the sections mentioned above. 
